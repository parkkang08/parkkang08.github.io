...
print("[DEBUG] static list       :", os.listdir(app.static_folder) if os.path.exists(app.static_folder) else "NOPE")
...
def test_start():
    return send_from_directory(app.static_folder, "start.mp3")
